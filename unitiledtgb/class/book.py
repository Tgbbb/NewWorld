...
win = tkinter.Tk()
win.title('图书库存管理系统V0.1')
win.geometry('300x400')
group = ttk.LabelFrame(win, text="图书库存管理系统")
    # 按钮
button1 = Button(group, text='显示书目信息')
button2 = Button(group, text='显示库存信息')
button3 = Button(group, text='添加书目信息',command=tianjia1)
button4 = Button(group, text='退出')
